...
fn main() {
    const ID: &str = "com.clawos.AppletWidgetRail";
    println!("cargo:rerun-if-changed=i18n");
    println!("cargo:rerun-if-changed=data/{ID}.desktop");
    let context = Context::new("i18n/", "desktop_entries").unwrap();
    let app = App::new(FluentString("claw-applet-widget-rail"))
        .comment(FluentString("claw-applet-widget-rail-comment"))
        .keywords(FluentString("claw-applet-widget-rail-keywords"));
    let desktop = app
