...
ai-search-ask-claw = Ask Claw to find an app for you
ai-search-ask-claw-q = Ask Claw to find an app for "{ $query }"
ai-search-ask-claw-hint = Describe what you want to do — Claw will search the store with AI.
