...
menu-about = Σχετικά με την Επεξεργασία κειμένου ClawOS...
cancel = Ακύρωση
...
cosmic-text-editor = Επεξεργασία κειμένου ClawOS
...
comment = Πρόγραμμα επεξεργασίας κειμένου για το περιβάλλον επιφάνειας εργασίας ClawOS
