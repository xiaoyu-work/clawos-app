...
//
// Embeddings modality sub-page. All real logic lives in `super::common`.
...
impl Default for Page {
    fn default() -> Self {
        Self {
            ...
            state: State::new(Modality::Embed),
        }
    }
}
...
impl page::Page<crate::pages::Message> for Page {
    ...
    fn info(&self) -> page::Info {
        page::Info::new(Modality::Embed.page_id(), Modality::Embed.icon_name())
            .title(Modality::Embed.title())
            .description(Modality::Embed.description())
    }
...
fn wrap(message: common::Message) -> crate::pages::Message {
    crate::pages::Message::Agent(Modality::Embed, message)
}
