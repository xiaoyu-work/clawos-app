...
//
// LLM modality sub-page. All real logic lives in `super::common`.
...
impl page::Page<crate::pages::Message> for Page {
    ...
    fn info(&self) -> page::Info {
        page::Info::new(Modality::Llm.page_id(), Modality::Llm.icon_name())
            .title(Modality::Llm.title())
            .description(Modality::Llm.description())
    }
...
fn wrap(message: common::Message) -> crate::pages::Message {
    crate::pages::Message::Agent(Modality::Llm, message)
}
