...
//
// TTS modality sub-page. All real logic lives in `super::common`.
...
impl page::Page<crate::pages::Message> for Page {
    ...
    fn info(&self) -> page::Info {
        page::Info::new(Modality::Tts.page_id(), Modality::Tts.icon_name())
            .title(Modality::Tts.title())
            .description(Modality::Tts.description())
    }
...
fn wrap(message: common::Message) -> crate::pages::Message {
    crate::pages::Message::Agent(Modality::Tts, message)
}
