...
//
// STT modality sub-page. All real logic lives in `super::common`.
...
impl page::Page<crate::pages::Message> for Page {
    ...
    fn info(&self) -> page::Info {
        page::Info::new(Modality::Stt.page_id(), Modality::Stt.icon_name())
            .title(Modality::Stt.title())
            .description(Modality::Stt.description())
    }
...
fn wrap(message: common::Message) -> crate::pages::Message {
    crate::pages::Message::Agent(Modality::Stt, message)
}
