...
xdg-entry-mouse-keywords = ClawOS;Миша;Прискорення;Прокручування;Гортання;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-notifications-keywords = ClawOS;Сповіщення;Блокування;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-startup-apps-keywords = ClawOS;Автозапуск;Запуск;Застосунок;Програма;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-wired-keywords = ClawOS;Дротове;LAN;Мережа;З'єднання;Підключення;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-appearance-keywords = ClawOS;Колір;Акценту;Піктограма;Іконка;Значок;Шрифт;Черенки;Тема;КОСМІК;КОСМОС;КОСМІЧНЕ
xdg-entry-dock-keywords = ClawOS;Область;Завдань;Док;Панель;Віджет;КОСМІК;КОСМОС;КОСМІЧНЕ
xdg-entry-panel-keywords = ClawOS;Панель;Віджет;КОСМІК;КОСМОС;КОСМІЧНЕ
xdg-entry-desktop-keywords = ClawOS;Стільниця;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-x11-applications-keywords = ClawOS;X11;Застосунок;Програма;Гра;Сумісність;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-touchpad-keywords = ClawOS;Сенсорна;Панель;Тачпад;Жести;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-system-keywords = ClawOS;Про;Систему;Система;Інформація;Облікові;Записи;Обліковка;Мікропрограма;Прошивка;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-wireless-keywords = ClawOS;WiFi;Wi-Fi;Мережа;З'єднання;Підключення;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-about-keywords = ClawOS;Про;Систему;КОСМІК;КОСМОС;КОСМІЧНЕ
xdg-entry-a11y-keywords = ClawOS;Доступність;Екран;Читач;Диктор;Лупа;Контраст;Колір;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-date-time-keywords = ClawOS;Час;Часовий;Пояс;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-network-keywords = ClawOS;Мережа;Бездротове;WiFi;VPN;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-workspaces-keywords = ClawOS;Робочий;Простір;Простори;Режим;Огляду;Огляд;Орієнтація;Монітор;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-wallpaper-keywords = ClawOS;Тло;Шпалери;Показ;Слайдів;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-users-keywords = ClawOS;Користувач;Обліковий;Запис;Обліковка;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-vpn-keywords = ClawOS;VPN;Мережа;З'єднання;Підключення;OpenVPN;OpenConnect;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-time-language-keywords = ClawOS;Система;Час;Дата;Регіон;Мова;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-input-keywords = ClawOS;Ввід;Клавіатура;Миша;Миші;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-sound-keywords = ClawOS;Звук;Аудіо;Сповіщення;Сигнал;Pipewire;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-power-keywords = ClawOS;Живлення;Акумулятор;КОСМІК;КОСМОС;КОСМІЧНЕ
xdg-entry-default-apps-keywords = ClawOS;Типові;Застосунки;Програми;КОСМІК;КОСМОС;КОСМІЧНЕ
xdg-entry-keywords = ClawOS;Налаштування;Настройки;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-region-language-keywords = ClawOS;Регіон;Мова;Дата;Формат;Час;Локалізація;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-applications-keywords = ClawOS;Автозапуск;X11;Типові;Застосунок;Програма;Запуск;Сумісність;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-keyboard-keywords = ClawOS;Клавіатура;Ввід;Джерело;Сполучення;Клавіш;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-window-management-keywords = ClawOS;Керувати;Вікнами;Укладання;Мозаїка;Tiling;Клавіша;Super;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-displays-keywords = ClawOS;Дисплей;Екран;КОСМІК;КОСМОС;КОСМІЧНЕ;
xdg-entry-bluetooth-keywords = ClawOS;Bluetooth;Блютуз;Бездротове;З’єднання;КОСМІК;КОСМОС;КОСМІЧНЕ;
