...
enable-export = Aplicar o tema atual para aplicativos GNOME
    .desc = Nem todos os toolkits suportam trocar automaticamente. Aplicativos que não são de ClawOS podem precisar ser reiniciados após uma mudança de tema.
...
xdg-entry-mouse-keywords = ClawOS;Mouse;Aceleração;Rolagem;
xdg-entry-bluetooth-comment = Gerenciar dispositivos Bluetooth
xdg-entry-notifications-keywords = ClawOS;Notificação;Bloqueio;
xdg-entry-startup-apps-keywords = ClawOS;Iniciar;Inicialização;Aplicativo;
...
xdg-entry-wired-keywords = ClawOS;Wired;Cabeada;LAN;Rede;Conexão;
xdg-entry-power = Energia e bateria
xdg-entry-appearance-keywords = ClawOS;Destaque;Accent;Cor;Ícone;Fonte;Tema
xdg-entry-mouse = Mouse
xdg-entry-dock-keywords = ClawOS;Dock;Painel;Applet;Miniaplicativo
xdg-entry-mouse-comment = Velocidade do mouse, aceleração e rolagem natural
xdg-entry-system = Sistema e contas
xdg-entry-panel-keywords = ClawOS;Painel;Applet;Miniaplicativo
...
xdg-entry-desktop-keywords = ClawOS;Desktop;Área;Trabalho;
xdg-entry-x11-applications-keywords = ClawOS;X11;Aplicativo;Jogos;Compatibilidade;
xdg-entry-displays-comment = Gerenciar configurações de tela
xdg-entry-touchpad-keywords = ClawOS;Touchpad;Gestos;
xdg-entry-time-language = Hora e idioma
xdg-entry-users = Usuários
xdg-entry-system-keywords = ClawOS;Sistema;Info;Contas;Firmware;
xdg-entry-default-apps = Aplicativos padrão
xdg-entry-wireless-keywords = ClawOS;WiFi;Wi-Fi;Rede;Conexão;
...
xdg-entry-about-keywords = ClawOS;Sobre
xdg-entry-panel = Painel
xdg-entry-notifications = Notificações
xdg-entry-a11y-keywords = ClawOS;Acessibilidade;A11y;Tela;Leitor;Lupa;Ampliador;Contraste;Cor;
xdg-entry-wireless-comment = Conexões Wi-Fi e perfis de conexão
xdg-entry-desktop = Área de trabalho
xdg-entry-date-time-keywords = ClawOS;Hora;Fuso;
...
xdg-entry-network-keywords = ClawOS;Rede;Conexão;fio;Wireless;WiFi;VPN;
...
xdg-entry-workspaces-keywords = ClawOS;Espaço;Trabalho;Orientação;Visão;Geral;Monitor;Tela;
...
xdg-entry-wallpaper-keywords = ClawOS;Wallpaper;PapelParede;Background;Slideshow;Transição;Plano;Fundo;
xdg-entry-users-keywords = ClawOS;Usuário;Conta;
xdg-entry-about-comment = Nome do dispositivo, informações de hardware, padrões do sistema operacional
xdg-entry-vpn-keywords = ClawOS;VPN;Rede;Conexão;OpenVPN;OpenConnect;
xdg-entry-appearance-comment = Cores de destaque e temas
xdg-entry-time-language-keywords = ClawOS;Sistema;Hora;Data;Região;idioma;
xdg-entry-input-keywords = ClawOS;Entrada;Teclado;Mouse;
xdg-entry-comment = Aplicativo de configurações para o ambiente ClawOS
...
xdg-entry-sound-keywords = ClawOS;Som;Áudio;Alerta;Pipewire;
xdg-entry-power-keywords = ClawOS;Energia;Bateria
xdg-entry-default-apps-keywords = ClawOS;Padrão;Aplicativo
xdg-entry-keywords = ClawOS;Configurações;
xdg-entry-region-language-keywords = ClawOS;Região;Idioma;Data;Formato;Hora;Localização;
xdg-entry-about = Sobre
xdg-entry-input = Dispositivos de entrada
xdg-entry-applications-keywords = ClawOS;Padrão;Aplicativo;Inicialização;Iniciar;X11;Compatibilidade
...
xdg-entry-keyboard-keywords = ClawOS;Teclado;Entrada;Dispositivos;Atalhos;
xdg-entry-vpn-comment = Conexões VPN e perfis de conexão
xdg-entry-appearance = Aparência
xdg-entry-window-management-keywords = ClawOS;Janela;Gerenciamento;Tiling;Lado;Super;Tecla;
...
xdg-entry-displays-keywords = ClawOS;Tela;Monitor;
