...
enable-export = Appliquer ce thème aux applications GNOME
    .desc = Certaines boîtes à outils ne supportent pas le changement automatique de thème. Les applications non-ClawOS peuvent nécessiter un redémarrage après un changement de thème.
...
workspaces-overview = Aperçu des espaces de travail
    ...
    .launcher = Ouvrir le lanceur
    .applications = Ouvrir les applications
xdg-entry-mouse-keywords = ClawOS;Souris;Accélération;Défilement;
xdg-entry-notifications-keywords = ClawOS;Notification;Verrouillage;
xdg-entry-startup-apps-keywords = ClawOS;Démarrage;Application;
xdg-entry-wired-keywords = ClawOS;Filaire;LAN;Réseau;Connexion;
xdg-entry-appearance-keywords = ClawOS;Accentuation;Couleur;Icône;Police;Thème
xdg-entry-dock-keywords = ClawOS;Dock;Panneau;Applet
xdg-entry-panel-keywords = ClawOS;Panneau;Applet
xdg-entry-time-language-comment = Gérer la date, l’heure, la région et la langue du système
xdg-entry-desktop-keywords = ClawOS;Bureau;
xdg-entry-x11-applications-keywords = ClawOS;X11;Application;Jeu;Compatibilité;
xdg-entry-touchpad-keywords = ClawOS;Pavé tactile;Gestes;
xdg-entry-system-keywords = ClawOS;Système;Info;Comptes;Firmware;
xdg-entry-wireless-keywords = ClawOS;WiFi;Wi-Fi;Réseau;Connexion;
xdg-entry-about-keywords = ClawOS;À propos
xdg-entry-a11y-keywords = ClawOS;Accessibilité,A11y;Écran;Lecteur;Loupe;Contraste;Couleur;
xdg-entry-date-time-keywords = ClawOS;Horaire;Fuseau;
...
xdg-entry-network-keywords = ClawOS;Réseau;Sans fil;Wi-Fi;VPN;
xdg-entry-wireless = Wi-Fi
xdg-entry-workspaces-keywords = ClawOS;Espace de travail;Orientation;Aperçu;Écran;
xdg-entry-system-comment = Informations système, comptes et mises à jour du firmware
xdg-entry-wallpaper-keywords = ClawOS;Fond d'écran;Arrière-plan;Diaporama;
xdg-entry-users-keywords = ClawOS;Utilisateur;Compte;
xdg-entry-vpn-keywords = ClawOS;VPN;Réseau;Connexion;OpenVPN;OpenConnect;
xdg-entry-time-language-keywords = ClawOS;Système;Heure;Date;Région;Langue;
xdg-entry-input-keywords = ClawOS;Saisie;Clavier;Souris;Souris;
xdg-entry-comment = Application Paramètres pour le bureau ClawOS
xdg-entry-sound-keywords = ClawOS;Son;Audio;Alerte;Pipewire;
xdg-entry-power-keywords = ClawOS;Alimentation;Batterie
xdg-entry-default-apps-keywords = ClawOS;Défaut;Application
xdg-entry-keywords = ClawOS;Paramètres;
xdg-entry-region-language-keywords = ClawOS;Région;Langue;Date;Format;Heure;Paramètres régionaux;Localisation;
xdg-entry-applications-keywords = ClawOS;Défaut;Application;Démarrage;X11;Compatibilité
xdg-entry-keyboard-keywords = ClawOS;Clavier;Saisie;Source;Raccourcis;
xdg-entry-window-management-keywords = ClawOS;Fenêtre;Gestion;Agencement;Super;Touche;
xdg-entry-displays-keywords = ClawOS;Écran;
