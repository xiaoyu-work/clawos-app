...
xdg-entry-about-keywords = ClawOS;Oor
xdg-entry-a11y = Toeganklikhede
xdg-entry-a11y-keywords = ClawOS;Toeganklikhede;A11y;Screen;Reader;Magnifier;Contrast;Color;
xdg-entry-appearance = Weergawe
xdg-entry-appearance-comment = Aksentkleure en temas
xdg-entry-appearance-keywords = ClawOS;Weergawe;Aksentkleure;Color;Icon;Font;Temas
...
xdg-entry-displays-keywords = ClawOS;Vertoonskerme;
xdg-entry-dock = Dock
