...
enable-export = Używaj tego motywu w aplikacjach GNOME.
    .desc = Nie wszystkie toolkity wspierają automatyczne zmiany. Aplikacje spoza ClawOS mogą wymagać restartu po zmianie motywu.
...
workspaces-overview = Podgląd obszarów roboczych
    ...
    .launcher = Otwórz Program Startowy
    .applications = Otwórz Aplikacje
xdg-entry-mouse-keywords = ClawOS;Mysz;Myszka;Przyśpieszenie;Akceleracja;Skrolowanie;Scrollowanie;
xdg-entry-notifications-keywords = ClawOS;Powiadomienia;Blokada;
xdg-entry-startup-apps-keywords = ClawOS;Aplikacje Startowe;Aplikacje;
xdg-entry-wired-keywords = ClawOS;Przewodowe;LAN;Sieć;Łącze;
xdg-entry-appearance-keywords = ClawOS;Akcenty;Kolor;Ikony;Czcionki;Wygląd;Styl
xdg-entry-dock-keywords = ClawOS;Dok;Panel;Aplet
xdg-entry-panel-keywords = ClawOS;Panel;Aplet
xdg-entry-time-language-comment = Zarządzaj datą, czasem, regionem i językiem systemu
xdg-entry-desktop-keywords = ClawOS;Środowisko Graficzne;
xdg-entry-x11-applications-keywords = ClawOS;X11;Aplikacje;Gry;Zgodność;
xdg-entry-touchpad-keywords = ClawOS;Gładzik;Gesty;
xdg-entry-system-keywords = ClawOS;System;Informacje;Konta;Firmware;Mikrooprogramowanie;
xdg-entry-wireless-keywords = ClawOS;WiFi;Wi-Fi;Sieć;Połączenie;Łącze;
xdg-entry-applications-comment = Domyślne aplikacje, aplikacje startowe oraz ustawienia zgodności aplikacji X11
xdg-entry-about-keywords = ClawOS;O programie
xdg-entry-a11y-keywords = ClawOS;Dostępność;A11y;Ekran;Czytnik;Lupa;Kontrast;Kolor;
xdg-entry-date-time-keywords = ClawOS;Czas;Strefa Czasowa;
...
xdg-entry-network-keywords = ClawOS;Sieci;Bezprzewodowe;WIFI;VPN;
xdg-entry-wireless = WI-FI
xdg-entry-workspaces-keywords = ClawOS;Obszary Robocze;Orientacja;Kierunek;Podgląd;Monitor;Wyświetlacz;
xdg-entry-system-comment = Informacje o Systemie, konta i aktualizacje firmware
xdg-entry-wallpaper-keywords = ClawOS;Tapeta;Tło;Pokaz Slajdów;Slajdy;
xdg-entry-users-keywords = ClawOS;Użytkownik;Konto;
xdg-entry-vpn-keywords = ClawOS;VPN;Sieć;Połączenie;OpenVPN;OpenConnect;
xdg-entry-time-language-keywords = ClawOS;System;Czas;Data;Region;Język;
xdg-entry-input-keywords = ClawOS;Wejście;Klawiatura;Mysz;Myszka;
xdg-entry-comment = Aplikacja ustawień dla środowiska graficznego ClawOS
xdg-entry-sound-keywords = ClawOS;Dźwięk;Audio;Powiadomienie; Pipewire;
xdg-entry-power-keywords = ClawOS;Zasilanie;Bateria
xdg-entry-default-apps-keywords = ClawOS;Dosyślne;Aplikacje
xdg-entry-keywords = ClawOS;Ustawienia;
xdg-entry-region-language-keywords = ClawOS;Region;Język;Data;Format;Czas;Ustawienia Regionalne;Położenie;Lokalizacja;
xdg-entry-applications-keywords = ClawOS;Domyślnie;Aplikacje;Startowe;X11;Zgodność
xdg-entry-keyboard-keywords = ClawOS;Klawiatura;Wejście;Źródła;Skróty;
xdg-entry-window-management-keywords = ClawOS;Okna;Zarządzanie;Kafelkowanie;Super;Klawisz;Przycisk;
xdg-entry-panel-comment = Podstawowy panel z menu i apletami
xdg-entry-displays-keywords = ClawOS;Wyświetlacz;Ekran;
