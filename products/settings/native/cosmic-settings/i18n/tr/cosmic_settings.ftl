...
enable-export = Bu temayı GNOME uygulamalarına uygula
    .desc = Bütün toolkitler otomatik tema değişimi desteklemez. ClawOS dışı uygulamaların tema değişimi için uygulamanın yeniden başlatılması gerekebilir.
...
xdg-entry-mouse-keywords = ClawOS;Fare; Hızlanma; Kaydırma;
xdg-entry-bluetooth-comment = Bluetooth cihazlarını yönetin
xdg-entry-notifications-keywords = ClawOS;Bildirim;Kilit;
...
xdg-entry-appearance-keywords = ClawOS;Vurgu;Renk;Simge;Yazı Tipi;Tema
xdg-entry-mouse = Fare
xdg-entry-dock-keywords = ClawOS;Dock;Panel;Eklenti
xdg-entry-mouse-comment = Fare hızı, ivme ve doğal kaydırma
xdg-entry-panel-keywords = ClawOS;Panel;Eklenti
xdg-entry-a11y = Erişilebilirlik
xdg-entry-desktop-keywords = ClawOS;Masaüstü;
...
xdg-entry-about-keywords = ClawOS;Hakkında
xdg-entry-panel = Panel
xdg-entry-notifications = Bildirimler
xdg-entry-a11y-keywords = ClawOS;Erişilebilirlik;A11y;Ekran;Okuyucu;Büyüteç;Kontrast;Renk;
xdg-entry-desktop = Masaüstü
xdg-entry-date-time-keywords = ClawOS;Saat;Zaman Dilimi;
...
xdg-entry-network-keywords = ClawOS;Ağ;Kablosuz;WiFi;VPN;
xdg-entry-dock = Dock
...
xdg-entry-input-keywords = ClawOS;Giriş;Klavye;Fare;Fareler;
...
xdg-entry-default-apps-keywords = ClawOS;Varsayılan;Uygulama
xdg-entry-keywords = ClawOS;Ayarlar;
xdg-entry-about = Hakkında
xdg-entry-input = Giriş Cihazları
xdg-entry-applications-keywords = ClawOS;Varsayılan;Uygulama;Başlangıç;X11;Uyumluluk
xdg-entry-keyboard-keywords = ClawOS;Klavye;Giriş;Kaynak;Kısayollar;
...
xdg-entry-displays-keywords = ClawOS;Ekran;
...
xdg-entry-startup-apps-keywords = ClawOS;Başlangıç;Uygulama;
xdg-entry-wired-keywords = ClawOS;Kablolu; Yerel Ağ; Ağ; Bağlantı;
...
xdg-entry-x11-applications-keywords = ClawOS;X11;Uygulama;Oyun;Uyumluluk;
xdg-entry-touchpad-keywords = ClawOS;Dokunmatik yüzey; Hareket;
xdg-entry-time-language = Zaman & Dil
xdg-entry-users = Kullanıcılar
xdg-entry-system-keywords = ClawOS;Sistem;Bilgi;Hesaplar;Cihaz Yazılımı;
xdg-entry-wireless-keywords = ClawOS;WiFi;Wi-Fi;Ağ; Bağlantı;
...
xdg-entry-workspaces-keywords = ClawOS;Çalışma Alanı; Yönlendirme; Genel Bakış; Monitör;
...
xdg-entry-wallpaper-keywords = ClawOS;Duvar kağıdı; Arka plan; Slayt gösterisi;
xdg-entry-users-keywords = ClawOS;Kullanıcı;Hesap;
xdg-entry-vpn-keywords = ClawOS;VPN;Ağ;Bağlantı;OpenVPN;OpenConnect;
xdg-entry-time-language-keywords = ClawOS;Sistem;Saat;Tarih;Bölge;Dil;
xdg-entry-sound-keywords = ClawOS;Ses;Sesli;Uyarı;Kablolu Sistem;
xdg-entry-power-keywords = ClawOS;Güç;Pil
xdg-entry-region-language-keywords = ClawOS;Bölge;Dil;Tarih;Biçim;Saat;Yerel Ayar;Yerelleştirme;
...
xdg-entry-window-management-keywords = ClawOS;Pencere;Yönetim;Döşeme;Süper;Anahtar;
