...
enable-export = Pas dit thema toe op GNOME-apps.
    .desc = Niet alle toolkit-omgevingen ondersteunen automatische thema wisseling. Niet-ClawOS-apps moeten mogelijk opnieuw worden opgestart na een themawijziging.
...
preferred-languages = Taalvoorkeur
    .desc = De volgorde van de talen bepaalt welke door ClawOS wordt gebruikt. Wijzigingen worden doorgevoerd nadat u zich opnieuw heeft aangemeld.
