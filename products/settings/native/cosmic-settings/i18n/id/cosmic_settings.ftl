...
enable-export = Terapkan tema saat ini ke aplikasi GNOME
    .desc = Tidak semua alat kit mendukung peralihan otomatis. Aplikasi non-ClawOS mungkin perlu dimulai ulang seletah perubahan tema.
...
xdg-entry-mouse-keywords = ClawOS;Tetikus;Akselerasi;Pengguliran;
xdg-entry-bluetooth-comment = Kelola perangkat Bluetooth
xdg-entry-notifications-keywords = ClawOS;Notifikasi;Kunci;
xdg-entry-startup-apps-keywords = ClawOS;Pemulaian;Aplikasi;
...
xdg-entry-wired-keywords = ClawOS;Berkabel;LAN;Jaringan;Sambungan;
xdg-entry-power = Daya & Baterai
xdg-entry-appearance-keywords = ClawOS;Aksen;Warna;Ikon;Huruf;Tema
...
xdg-entry-x11-applications-keywords = ClawOS;X11;Aplikasi;Permainan;Kompatibilitas;
xdg-entry-displays-comment = Kelola pengaturan konfigurasi layar
xdg-entry-touchpad-keywords = ClawOS;Papan Sentuh;Gerakan;
xdg-entry-time-language = Waktu & Bahasa
xdg-entry-users = Pengguna
xdg-entry-system-keywords = ClawOS;Sistem;Info;Akun;Firmware;
xdg-entry-default-apps = Aplikasi Bawaan
xdg-entry-wireless-keywords = ClawOS;WiFi;Wi-Fi;Jaringan;Sambungan;
xdg-entry-applications-comment = Pengaturan aplikasi bawaan, aplikasi pemulaian, dan kompatibilitas aplikasi X11
xdg-entry-about-keywords = ClawOS;Tentang
xdg-entry-panel = Panel
xdg-entry-notifications = Notifikasi
xdg-entry-a11y-keywords = ClawOS;Aksesibilitas;A11y;Layar;Pembaca;Kaca Pembesar;Kontras;Warna;
xdg-entry-wireless-comment = Sambungan Wi-Fi dan profil sambungan
xdg-entry-desktop = Desktop
xdg-entry-date-time-keywords = ClawOS;Waktu;Zona;
...
xdg-entry-network-keywords = ClawOS;Jaringan;Nirkabel;WiFi;VPN;
...
xdg-entry-workspaces-keywords = ClawOS;Ruang Kerja;Orientasi;Ikhtisar;Monitor;
...
xdg-entry-wallpaper-keywords = ClawOS;Wallpaper;Latar Belakang;Tayangan Salindia;
xdg-entry-users-keywords = ClawOS;Pengguna;Akun;
xdg-entry-about-comment = Nama perangkat, informasi perangkat keras, bawaan sistem operasi
xdg-entry-vpn-keywords = ClawOS;VPN;Jaringan;Sambungan;OpenVPN;OpenConnect;
xdg-entry-appearance-comment = Warna aksen dan tema
xdg-entry-time-language-keywords = ClawOS;Sistem;Waktu;Tanggal;Wilayah;Bahasa;
xdg-entry-input-keywords = ClawOS;Masukan;Papan Ketik;Tetikus;Tetikus;
...
xdg-entry-sound-keywords = ClawOS;Suara;Audio;Peringatan;Pipewire;
xdg-entry-power-keywords = ClawOS;Daya;Baterai
xdg-entry-default-apps-keywords = ClawOS;Bawaan;Aplikasi
xdg-entry-keywords = ClawOS;Pengaturan;
xdg-entry-region-language-keywords = ClawOS;Wilayah;Bahasa;Tanggal;Format;Waktu;Lokal;Lokalisasi;
xdg-entry-about = Tentang
xdg-entry-input = Perangkat Masukan
xdg-entry-applications-keywords = ClawOS;Bawaan;Aplikasi;Pemulaian;X11;Kompatibilitas
...
xdg-entry-keyboard-keywords = ClawOS;Papan Ketik;Masukan;Sumber;Pintasan;
xdg-entry-vpn-comment = Sambungan VPN dan profil sambungan
xdg-entry-appearance = Tampilan
xdg-entry-window-management-keywords = ClawOS;Jendela;Pengelolaan;Pengubinan;Super;Tombol;
...
xdg-entry-displays-keywords = ClawOS;Layar;
