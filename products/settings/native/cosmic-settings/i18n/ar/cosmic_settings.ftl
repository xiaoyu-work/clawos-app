...
enable-export = قم بتطبيق هذا المظهر على تطبيقات GNOME.
    .desc = لا تدعم جميع مجموعات الأدوات التبديل التلقائي. قد تحتاج التطبيقات غير التابعة لـ ClawOS إلى إعادة التشغيل بعد تغيير المظهر.
...
xdg-entry-about-keywords = ClawOS;عن;حول
xdg-entry-comment = تطبيق الإعدادات لسطح مكتب ClawOS
xdg-entry-keywords = ClawOS;إعدادات;
xdg-entry-window-management-comment = إجراء مفتاح Super وخيارات التحكم في النوافذ وخيارات إضافية تبليط النوافذ
xdg-entry-mouse-keywords = ClawOS;فأرة;تسارع;تمرير;
xdg-entry-notifications-keywords = ClawOS;إشعار;قفل;
xdg-entry-startup-apps-keywords = ClawOS;بدء التشغيل;تطبيق;
xdg-entry-wired-keywords = ClawOS;سلكي;LAN;شبكة;اتصال;
xdg-entry-appearance-keywords = ClawOS;تمييز;لون;أيقونة;خط;سمة;نسق
xdg-entry-dock-keywords = ClawOS;مرسى;لوحة;بريمج
xdg-entry-panel-keywords = ClawOS;لوحة;بريمج
xdg-entry-window-management = إدارة النوافذ
xdg-entry-time-language-comment = أدِر نظام التاريخ والتوقيت والمنطقة واللغة
xdg-entry-desktop-keywords = ClawOS;سطح المكتب;
xdg-entry-x11-applications-keywords = ClawOS;X11;تطبيق;لعبة;التوافق;
xdg-entry-touchpad-keywords = ClawOS;لوحة اللمس;إيماءة;
xdg-entry-system-keywords = ClawOS;النظام;المعلومات;الحسابات;البرمجيات الثابتة;
xdg-entry-wireless-keywords = ClawOS;واي فاي;Wi-Fi;شبكة;اتصال;
xdg-entry-applications-comment = التطبيقات المبدئية وتطبيقات بدء التشغيل وإعدادات توافق تطبيقات اكس11
xdg-entry-a11y-keywords = ClawOS;الإتاحة;A11y;شاشة;قارئ;مكبر;تباين;لون;
xdg-entry-wireless-comment = اتصالات الواي فاي وملفات تعريف الاتصال
xdg-entry-date-time-keywords = ClawOS;الوقت;المنطقة;
xdg-entry-wallpaper = الخلفية
xdg-entry-bluetooth-keywords = ClawOS;بلوتوث;
xdg-entry-network-keywords = ClawOS;شبكة;لاسلكي;واي فاي;VPN;ش‌خ‌ف;شبكة خاصة افتراضية;
xdg-entry-wallpaper-comment = صور الخلفية والألوان وخيارات عرض الشرائح
xdg-entry-wireless = واي فاي
xdg-entry-workspaces-keywords = ClawOS;مساحة العمل;التوجيه;نظرة عامة;الشاشة;
xdg-entry-system-comment = معلومات النظام والحسابات وتحديثات البرامج الثابتة
xdg-entry-wallpaper-keywords = ClawOS;خلفية;خلفية الشاشة;عرض شرائح;
xdg-entry-users-keywords = ClawOS;مستخدم;حساب;
xdg-entry-vpn-keywords = ClawOS;VPN;شبكة;اتصال;OpenVPN;OpenConnect;
xdg-entry-time-language-keywords = ClawOS;النظام;الوقت;التاريخ;المنطقة;اللغة;
xdg-entry-input-keywords = ClawOS;إدخال;لوحة مفاتيح;ماوس;فأرة;
xdg-entry-sound-keywords = ClawOS;صوت;صوتي;تنبيه;Pipewire;
xdg-entry-power-keywords = ClawOS;طاقة;مدخرة;بطارية
xdg-entry-default-apps-keywords = ClawOS;مبدئي;تطبيق
xdg-entry-region-language-keywords = ClawOS;المنطقة;اللغة;التاريخ;التنسيق;الوقت;الإعدادات المحلية;التوطين;
xdg-entry-applications-keywords = ClawOS;افتراضي;تطبيق;بدء التشغيل;X11;توافقية;مبدئي;اكس11
xdg-entry-keyboard-keywords = ClawOS;لوحة المفاتيح;الإدخال;المصدر;الاختصارات;
xdg-entry-window-management-keywords = ClawOS;إدارة;النوافذ;التبليط;مفتاح;Super;
xdg-entry-workspaces-comment = اتجاه مساحة العمل ونظرة عامة وسلوك الشاشات المتعدّدة
xdg-entry-displays-keywords = ClawOS;عرض;
