...
enable-export = Ағымдағы тақырыпты GNOME қолданбаларына іске асыру
    .desc = Барлық интерфейс жиынтықтары автоматты түрде ауысуды қолдамайды. ClawOS-ке жатпайтын қолданбаларды тақырып өзгергеннен кейін қайта іске қосу қажет болуы мүмкін.
...
xdg-entry-mouse-keywords = ClawOS;Тышқан;Үдеу;Айналдыру;
xdg-entry-bluetooth-comment = Bluetooth құрылғыларын басқару
xdg-entry-notifications-keywords = ClawOS;Хабарландыру;Құлыптау;
xdg-entry-startup-apps-keywords = ClawOS;Автоқосылу;Қолданба;
...
xdg-entry-wired-keywords = ClawOS;Сымды;LAN;Желі;Қосылым;
xdg-entry-power = Қуат және батарея
xdg-entry-appearance-keywords = ClawOS;Акцент;Түс;Таңбаша;Қаріп;Тема
...
xdg-entry-desktop-keywords = ClawOS;Жұмыс үстелі;
xdg-entry-x11-applications-keywords = ClawOS;X11;Қолданба;Ойын;Үйлесімділік;
xdg-entry-displays-comment = Экран конфигурациясының баптауларын басқару
xdg-entry-touchpad-keywords = ClawOS;Тачпад;Қимыл;
xdg-entry-time-language = Уақыт және тіл
xdg-entry-users = Пайдаланушылар
xdg-entry-system-keywords = ClawOS;Жүйе;Ақпарат;Тіркелгілер;Микробағдарлама;
xdg-entry-default-apps = Әдепкі қолданбалар
xdg-entry-wireless-keywords = ClawOS;WiFi;Wi-Fi;Желі;Қосылым;
...
xdg-entry-about-keywords = ClawOS;Осы туралы
xdg-entry-panel = Панель
xdg-entry-notifications = Хабарландырулар
xdg-entry-a11y-keywords = ClawOS;Арнайы мүмкіндіктер;A11y;Экран;Диктор;Лупа;Контраст;Түс;
xdg-entry-wireless-comment = Wi-Fi қосылымдары және қосылымдар профильдері
xdg-entry-desktop = Жұмыс үстелі
xdg-entry-date-time-keywords = ClawOS;Уақыт;Белдеу;
...
xdg-entry-network-keywords = ClawOS;Желі;Сымсыз;WiFi;VPN;
...
xdg-entry-workspaces-keywords = ClawOS;Жұмыс орны;Бағдар;Шолу;Монитор;
...
xdg-entry-wallpaper-keywords = ClawOS;Тұсқағаз;Фон;Слайдшоу;
xdg-entry-users-keywords = ClawOS;Пайдаланушы;Тіркелгі;
xdg-entry-about-comment = Құрылғы аты, жабдық туралы ақпарат, операциялық жүйенің әдепкі параметрлері
xdg-entry-vpn-keywords = ClawOS;VPN;Желі;Байланыс;OpenVPN;OpenConnect;
xdg-entry-appearance-comment = Акцентті түстер және темалар
xdg-entry-time-language-keywords = ClawOS;Жүйе;Уақыт;Күн;Аймақ;Тіл;
xdg-entry-input-keywords = ClawOS;Енгізу;Пернетақта;Тышқан;Тышқандар;
...
xdg-entry-sound-keywords = ClawOS;Дыбыс;Аудио;Ескерту;Pipewire;
xdg-entry-power-keywords = ClawOS;Қуат;Батарея
xdg-entry-default-apps-keywords = ClawOS;Әдепкі;Қолданба
xdg-entry-keywords = ClawOS;Баптаулар;
xdg-entry-region-language-keywords = ClawOS;Аймақ;Тіл;Күн;Пішім;Уақыт;Локаль;Локализация;
xdg-entry-about = Осы туралы
xdg-entry-input = Енгізу құрылғылары
xdg-entry-applications-keywords = ClawOS;Әдепкі;Қолданба;Автоқосылу;X11;Үйлесімділік
...
xdg-entry-keyboard-keywords = ClawOS;Пернетақта;Енгізу;Көз;Жарлықтар;
xdg-entry-vpn-comment = VPN байланыстары және байланыс профильдері
xdg-entry-appearance = Сыртқы түрі
xdg-entry-window-management-keywords = ClawOS;Терезе;Басқару;Қатар қою;Super;Перне;
...
xdg-entry-displays-keywords = ClawOS;Экран;
