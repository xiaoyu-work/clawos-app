...
enable-export = Jelenlegi téma alkalmazása a GNOME-alkalmazásokra
    .desc = Nem minden eszközkészlet támogatja az automatikus váltást. Előfordulhat, hogy a téma módosítása után újra kell indítani a nem ClawOS-alapú alkalmazásokat.
icon-theme = Ikontéma
...
workspaces-overview = Munkaterületek áttekintése
    ...
    .launcher = Indító megnyitása
    .applications = Alkalmazások megnyitása
xdg-entry-mouse-keywords = ClawOS;Egér;Gyorsítás;Görgetés;
xdg-entry-notifications-keywords = ClawOS;Értesítés;Zárolás;Ne zavarjanak;
xdg-entry-startup-apps-keywords = ClawOS;Automatikus;Indítási alkalmazás;
xdg-entry-appearance-keywords = ClawOS;Kiemelő;Szín;Ikon;Betűkészlet;Téma;
xdg-entry-dock-keywords = ClawOS;Dokk;Panel;Kisalkalmazás;
xdg-entry-panel-keywords = ClawOS;Panel;Kisalkalmazás;
xdg-entry-time-language-comment = Rendszerdátum, idő, régió és a nyelv kezelése
xdg-entry-desktop-keywords = ClawOS;Asztal;
xdg-entry-system-keywords = ClawOS;Rendszer;Információk;Fiókok;Firmware;
xdg-entry-about-keywords = ClawOS;Névjegy
xdg-entry-panel = Panel
xdg-entry-a11y-keywords = ClawOS;Akadálymentesség;Képernyő;Olvasó;Nagyító;Kontraszt;Szín;
xdg-entry-date-time-keywords = ClawOS;Idő;Zóna;
...
xdg-entry-network-keywords = ClawOS;Hálózat;Vezeték;Nélküli;WiFi;VPN;
xdg-entry-system-comment = Rendszerinformációk, fiókok és firmware-frissítések
xdg-entry-time-language-keywords = ClawOS;Rendszer;Idő;Dátum;Régió;Nyelv;
xdg-entry-input-keywords = ClawOS;Bevitel;Billentyűzet;Egér;Egerek;
xdg-entry-sound-keywords = ClawOS;Hang;Figyelmeztetés;PipeWire;
xdg-entry-power-keywords = ClawOS;Energia;Akkumulátor;
xdg-entry-default-apps-keywords = ClawOS;Alapértelmezett;Alkalmazások;
xdg-entry-keywords = ClawOS;Beállítások;
xdg-entry-region-language-keywords = ClawOS;Régió;Nyelv;Dátum;Formátum;Idő;Területi;Beállítások;
xdg-entry-applications-keywords = ClawOS;Alapértelmezett;Alkalmazások;Indítás;X11;Támogatás;
xdg-entry-keyboard-keywords = ClawOS;Billentyűzet;Beviteli;Forrás;Gyorsbillentyűk;
xdg-entry-displays-keywords = ClawOS;Kijelző;
xdg-entry-wired-keywords = ClawOS;Vezetékes;LAN;Hálózat;Kapcsolat;
xdg-entry-x11-applications-keywords = ClawOS;X11;Alkalmazás;Játék;Támogatás;
xdg-entry-touchpad-keywords = ClawOS;Érintőpárna;Mozdulat;
xdg-entry-wireless-keywords = ClawOS;WiFi;Wi-Fi;Hálózat;Kapcsolat;
xdg-entry-wireless = Wi-Fi
xdg-entry-workspaces-keywords = ClawOS;Munkaterület;Tájolás;Áttekintés;Monitor;
xdg-entry-wallpaper-keywords = ClawOS;Háttérkép;Háttér;Diavetítés;
xdg-entry-users-keywords = ClawOS;Felhasználó;Fiók;
xdg-entry-vpn-keywords = ClawOS;VPN;Hálózat;Kapcsolat;OpenVPN;OpenConnect;
xdg-entry-comment = Beállításalkalmazás a ClawOS asztalhoz
xdg-entry-window-management-keywords = ClawOS;Ablak;Kezelés;Csempézés;Super;BIllentyű;
