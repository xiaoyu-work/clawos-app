...
enable-export = Aplicar este tema a las aplicaciones GNOME.
    .desc = No todos los conjuntos de herramientas soportan el cambio automático. Las aplicaciones que no sean ClawOS pueden necesitar ser reiniciadas después de un cambio de tema.
