...
enable-export = 將目前主題套用至 GNOME 應用程式
    .desc = 並非所有工具組都支援自動切換。非 ClawOS 應用程式在主題變更後可能需要重新啟動。
icon-theme = 圖示主題
    .desc = 套用不同的圖示集至應用程式
text-tint = 介面文字色調
...
xdg-entry-dock = 程式塢
xdg-entry-displays-keywords = ClawOS;顯示器;熒幕;
xdg-entry-displays-comment = 管理顯示器設定
xdg-entry-displays = 顯示器
xdg-entry-desktop-keywords = ClawOS;桌面;
xdg-entry-desktop = 桌面
xdg-entry-default-apps-keywords = ClawOS;預設;應用程式
xdg-entry-default-apps = 預設應用程式
xdg-entry-date-time-keywords = ClawOS;時間;時區;
xdg-entry-date-time-comment = 時區、自動時鐘設定和時間格式
xdg-entry-date-time = 日期與時間
xdg-entry-bluetooth-keywords = ClawOS;藍牙;
xdg-entry-bluetooth-comment = 管理藍牙裝置
xdg-entry-applications-keywords = ClawOS;預設;應用程式;啟動;X11;兼容性
xdg-entry-applications-comment = 預設應用程式、啟動應用程式和 X11 應用程式兼容性設定
xdg-entry-appearance-keywords = ClawOS;強調色;颜色;圖示;字體;主題
xdg-entry-appearance-comment = 強調色和主題
xdg-entry-applications = 應用程式
xdg-entry-appearance = 外觀
xdg-entry-a11y-keywords = ClawOS;無障礙;A11y;螢幕;閱讀器;放大鏡;對比;對比度;颜色;色彩;
xdg-entry-a11y-comment = 螢幕閱讀器、放大鏡、高對比以及濾色鏡
xdg-entry-a11y = 無障礙
xdg-entry-about-keywords = ClawOS;關於
xdg-entry-about-comment = 裝置名稱、硬體資訊、作業系統預設
xdg-entry-about = 關於
xdg-entry-keywords = ClawOS;設定;
xdg-entry-dock-keywords = ClawOS;程式塢;面板;工具程式
xdg-entry-region-language = 地區與語言
xdg-entry-notifications-keywords = ClawOS;通知;鎖定;
xdg-entry-power = 電源與電池
xdg-entry-panel-keywords = ClawOS;面板;工具程式
xdg-entry-panel = 面板
...
xdg-entry-sound-keywords = ClawOS;音響;音訊;提醒;Pipewire;
xdg-entry-power-keywords = ClawOS;電源;電池
xdg-entry-region-language-keywords = ClawOS;地區;語言;日期;格式;時間;本地;本地化;
xdg-entry-sound-comment = 裝置、提醒和應用程式的音訊設定
xdg-entry-panel-comment = 主要系統列， 用於選單和工具程式
xdg-entry-sound = 音響
xdg-entry-power-comment = 電源模式和省電選項
xdg-entry-network-keywords = ClawOS;網路;無線;WiFi;VPN;
xdg-entry-network-comment = 管理網路連線
xdg-entry-network = 網路與無線
xdg-entry-mouse-keywords = ClawOS;滑鼠;加速度;滾動;
xdg-entry-mouse-comment = 滑鼠速度、加速度和自然滾動
xdg-entry-mouse = 滑鼠
xdg-entry-keyboard-keywords = ClawOS;鍵盤;輸入;輸入源;快速鍵;
xdg-entry-keyboard-comment = 輸入源、切換、特殊字符輸入、快速鍵
xdg-entry-keyboard = 鍵盤
xdg-entry-input-keywords = ClawOS;輸入;鍵盤;滑鼠;
...
xdg-entry-startup-apps-keywords = ClawOS;開機啟動;應用程式;
xdg-entry-wired-keywords = ClawOS;有線連接;LAN;網路;連接;
xdg-entry-system = 系統與帳號
xdg-entry-window-management = 視窗管理
xdg-entry-time-language-comment = 管理系統日期、時間、區域及語言
xdg-entry-x11-applications-keywords = ClawOS;X11;應用程式;遊戲;相容性;
xdg-entry-time-language = 時間與語言
xdg-entry-users = 使用者
xdg-entry-system-keywords = ClawOS;系統;資訊;帳號;韌體;
xdg-entry-wireless-keywords = ClawOS;WiFi;Wi-Fi;網路;連接;
...
xdg-entry-workspaces-keywords = ClawOS;工作區;方向;總覽;螢幕;
xdg-entry-system-comment = 系統資訊、帳號及韌體更新
xdg-entry-x11-applications-comment = X11 視窗系統應用程式縮放大小、主要顯示螢幕和整體快速鍵
xdg-entry-wallpaper-keywords = ClawOS;背景圖片;背景;投影片;
xdg-entry-users-keywords = ClawOS;使用者;帳戶;
xdg-entry-vpn-keywords = ClawOS;VPN;網路;連接;OpenVPN;OpenConnect;
xdg-entry-time-language-keywords = ClawOS;系統;時間;日期;地區;語言;
xdg-entry-touchpad-comment = 觸控板速度、點按選項及手勢
xdg-entry-vpn-comment = VPN 連接和連接設定檔案
xdg-entry-window-management-keywords = ClawOS;視窗;管理;平鋪;Super;鍵;
...
network-name = 網路名稱
xdg-entry-touchpad-keywords = ClawOS;觸控板;手勢;
