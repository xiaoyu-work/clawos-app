...
enable-export = Cuir an téama seo i bhfeidhm ar aipeanna GNOME.
    .desc = Ní thacaíonn gach tacar uirlisí le huath-athrú. B’fhéidir go mbeadh gá aipeanna nach bhfuil i ClawOS a atosú tar éis athrú téama.
...
xdg-entry-desktop-keywords = ClawOS;Deasc;
xdg-entry-wireless-keywords = ClawOS;WiFi;Wi-Fi;Líonra;Ceangal;
xdg-entry-about-keywords = ClawOS;Maidir
xdg-entry-desktop = Deasc
xdg-entry-date-time-keywords = ClawOS;Am;Crios;
...
xdg-entry-default-apps-keywords = ClawOS;Réamhshocrú;Feidhmchlár
xdg-entry-keywords = ClawOS;Socruithe;
xdg-entry-about = Maidir
xdg-entry-appearance = Dealramh
xdg-entry-workspaces = Spásanna Oibre
xdg-entry-mouse-keywords = ClawOS;Luch;Luasghéarú;Scrolláil;
xdg-entry-keyboard-comment = Foinsí ionchuir, athrú, iontráil carachtar speisialta, aicearraí
xdg-entry-mouse = Luch
xdg-entry-dock-keywords = ClawOS;Duga;Painéal;Feidhmchláirín
...
xdg-entry-dock = Duga
xdg-entry-input-keywords = ClawOS;Ionchur;Méarchlár;Luch;Luchóga;
xdg-entry-input = Gléasanna Ionchuir
xdg-entry-keyboard-keywords = ClawOS;Méarchlár;Ionchur;Foinse;Aicearraí;
...
xdg-entry-notifications-keywords = ClawOS;Fógra;Glasáil;
xdg-entry-startup-apps-keywords = ClawOS;Tosú;Feidhmchlár;
...
xdg-entry-wired-keywords = ClawOS;Sreangaithe;Líonra Ceantair Áitiúil;Líonra;Nasc;
xdg-entry-power = Cumhacht & Ceallraí
xdg-entry-appearance-keywords = ClawOS;Béim;Dath;Deilbhín;Cló;Téama
xdg-entry-system = Córas & Cuntais
xdg-entry-panel-keywords = ClawOS;Painéal;Feidhmchláirín
...
xdg-entry-x11-applications-keywords = ClawOS;X11;Feidhmchlár;Cluiche;Comhoiriúnacht;
xdg-entry-displays-comment = Bainistigh socruithe cumraíochta taispeána
xdg-entry-touchpad-keywords = ClawOS;Ceap tadhaill;Gothaí;
xdg-entry-time-language = Am & Teanga
xdg-entry-users = Úsáideoirí
xdg-entry-system-keywords = ClawOS;Córas;Eolas;Cuntais;Dochtearraí;
...
xdg-entry-a11y-keywords = ClawOS;Inrochtaineacht;A11y;Scáileán;Léitheoir;Formhéadaitheoir;Codarsnacht;Dath;
...
xdg-entry-network-keywords = ClawOS;Líonra;Gan Sreang;WiFi;VPN;
...
xdg-entry-workspaces-keywords = ClawOS;Spás Oibre;Treoshuíomh;Forbhreathnú;Monatóir;
...
xdg-entry-wallpaper-keywords = ClawOS;Cúlbhrat;Cúlra;Taispeántas sleamhnán;
xdg-entry-users-keywords = ClawOS;Úsáideoir;Cuntas;
xdg-entry-about-comment = Ainm gléis, faisnéis crua-earraí, réamhshocruithe córais oibriúcháin
xdg-entry-vpn-keywords = ClawOS;VPN;Líonra;Nasc;OpenVPN;OpenConnect;
xdg-entry-appearance-comment = Dathanna béime agus téamaí
xdg-entry-time-language-keywords = ClawOS;Córas;Am;Dáta;Réigiún;Teanga;
...
xdg-entry-sound-keywords = ClawOS;Fuaim;Cloisteáil;Foláireamh;Pipewire;
xdg-entry-power-keywords = ClawOS;Cumhacht;Ceallraí
xdg-entry-region-language-keywords = ClawOS;Réigiún;Teanga;Dáta;Formáid;Am;Suíomh;Logánú;
xdg-entry-applications-keywords = ClawOS;Réamhshocrú;Feidhmchlár;Tosaithe;X11;Comhoiriúnacht
...
xdg-entry-window-management-keywords = ClawOS;Fuinneog;Bainistíocht;Tíliú;Super;Eochair;
...
xdg-entry-displays-keywords = ClawOS;Taispeántas;
