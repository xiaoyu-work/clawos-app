...
remove = 移除
settings = 设置
ai-search-no-results = 没有匹配 “{ $query }” 的设置页面。
ai-search-ask-claw = 让 Claw 帮你找设置
ai-search-ask-claw-hint = 点击打开 Claw AI 浮层，让它替你检索。
username = 用户名
...
enable-export = 将此主题应用到 GNOME 应用程序
    .desc = 并非所有工具包都支持自动切换。非 ClawOS 应用程序可能需要在主题更改后重新启动。
icon-theme = 图标主题
    .desc = 为应用程序应用另一套图标集
text-tint = 界面文字色调
...
workspaces-overview = 工作区总览
    ...
    .launcher = 开启启动器
    .applications = 打开应用程序
xdg-entry-about-keywords = ClawOS;关于
xdg-entry-wireless = Wi-Fi
xdg-entry-comment = ClawOS 桌面的设置应用程序
xdg-entry-mouse-keywords = ClawOS;鼠标;加速度;滚动;
xdg-entry-notifications-keywords = ClawOS;通知;锁屏;
xdg-entry-startup-apps-keywords = ClawOS;自动启动;应用程序;
xdg-entry-wired-keywords = ClawOS;有线;LAN;网络;连接;
xdg-entry-appearance-keywords = ClawOS;主题色;颜色;图标;字体;主题
xdg-entry-dock-keywords = ClawOS;程序坞;面板;小部件
xdg-entry-panel-keywords = ClawOS;面板;小部件
xdg-entry-time-language-comment = 管理系统日期、时间、地区和语言
xdg-entry-desktop-keywords = ClawOS;桌面;
xdg-entry-x11-applications-keywords = ClawOS;X11;应用程序;游戏;兼容性;
xdg-entry-touchpad-keywords = ClawOS;触摸板;手势;
xdg-entry-system-keywords = ClawOS;系统;信息;账户;固件;
xdg-entry-wireless-keywords = ClawOS;WiFi;Wi-Fi;网络;连接;
xdg-entry-a11y-keywords = ClawOS;无障碍;A11y;屏幕;阅读器;放大镜;对比;对比度;颜色;色彩;
xdg-entry-date-time-keywords = ClawOS;时间;时区;
xdg-entry-desktop-comment = 壁纸、外观、面板、程序坞、窗口管理和工作区设置
xdg-entry-bluetooth-keywords = ClawOS;蓝牙;
xdg-entry-network-keywords = ClawOS;网络;无线;WiFi;VPN;
xdg-entry-workspaces-keywords = ClawOS;工作区;方向;总览;显示屏;
xdg-entry-wallpaper-keywords = ClawOS;壁纸;背景;幻灯片;
xdg-entry-users-keywords = ClawOS;用户;账户;
xdg-entry-vpn-keywords = ClawOS;VPN;网络;连接;OpenVPN;OpenConnect;
xdg-entry-time-language-keywords = ClawOS;系统;时间;日期;地区;语言;
xdg-entry-input-keywords = ClawOS;输入;键盘;鼠标;
xdg-entry-sound-keywords = ClawOS;声音;音频;警报;Pipewire;
xdg-entry-power-keywords = ClawOS;电源;电池
xdg-entry-default-apps-keywords = ClawOS;默认;应用程序
xdg-entry-keywords = ClawOS;设置;
xdg-entry-region-language-keywords = ClawOS;地区;语言;日期;格式;时间;当地;本地化;
xdg-entry-applications-keywords = ClawOS;默认;应用程序;自动启动;X11;兼容性
xdg-entry-keyboard-keywords = ClawOS;键盘;输入;输入源;快捷键;
xdg-entry-window-management-keywords = ClawOS;窗口;管理;平铺;Super;键;
xdg-entry-displays-keywords = ClawOS;显示器;屏幕;
