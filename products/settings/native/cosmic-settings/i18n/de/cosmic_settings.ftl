...
enable-export = Aktuelles Thema auf GNOME-Apps anwenden
    .desc = Nicht alle Toolkits unterstützen den automatischen Wechsel. Nicht-ClawOS-Apps müssen nach einem Themenwechsel möglicherweise neu gestartet werden.
...
xdg-entry-about-keywords = ClawOS;Über
...
xdg-entry-dock = Dock
xdg-entry-input-keywords = ClawOS;Eingabe;Tastatur;Maus;Mäuse;
xdg-entry-comment = Einstellungsanwendung für den ClawOS Desktop
xdg-entry-applications = Anwendungen
xdg-entry-default-apps-keywords = ClawOS;Standard;Anwendung
xdg-entry-keywords = ClawOS;Einstellungen;
xdg-entry-about = Über
xdg-entry-input = Eingabegeräte
xdg-entry-applications-keywords = ClawOS;Standard;Anwendung;Start;X11;Kompatibilität
xdg-entry-appearance = Aussehen
xdg-entry-displays-keywords = ClawOS;Bildschirm;
save = Speichern
...
xdg-entry-x11-applications-keywords = ClawOS;X11;Anwendung;Spiel;Kompatibilität;
...
xdg-entry-workspaces-keywords = ClawOS;Arbeitsfläche;Ausrichtung;Übersicht;Monitor;
xdg-entry-wireless-keywords = ClawOS;WLAN;Netzwerk;Verbindung;
xdg-entry-wireless-comment = WLAN-Verbindungen und Verbindungsprofile
xdg-entry-wireless = WLAN
xdg-entry-wired-keywords = ClawOS;Kabelgebunden;LAN;Netzwerk;Verbindung;
xdg-entry-wired-comment = Kabelgebundene Verbindungen und Verbindungsprofile
xdg-entry-wired = Kabelgebunden
xdg-entry-window-management-keywords = ClawOS;Fenster;Verwaltung;Kachelung;Super;Taste;
...
xdg-entry-sound-keywords = ClawOS;Klang;Audio;Alarm;Pipewire;
xdg-entry-sound-comment = Audioeinstellungen für Geräte, Alarme und Anwendungen
xdg-entry-sound = Klang
xdg-entry-region-language-keywords = ClawOS;Region;Sprache;Datum;Format;Uhrzeit;Gebietsschema;Lokalisierung;
...
xdg-entry-power-keywords = ClawOS;Energie;Akku
...
xdg-entry-date-time-keywords = ClawOS;Zeit;Zone;
...
xdg-entry-touchpad-keywords = ClawOS;Touchpad;Geste;
...
xdg-entry-notifications-keywords = ClawOS;Benachrichtigung;Sperre;
...
xdg-entry-network-keywords = ClawOS;Netzwerk;Drahtlos;WLAN;VPN;
xdg-entry-network = Netzwerk & Drahtlos
xdg-entry-mouse-keywords = ClawOS;Maus;Beschleunigung;Scrollen;
xdg-entry-mouse-comment = Mausgeschwindigkeit, -beschleunigung und natürliches Scrollen
xdg-entry-mouse = Maus
xdg-entry-keyboard-keywords = ClawOS;Tastatur;Eingabe;Quelle;Tastenkombinationen;
...
xdg-entry-wallpaper-keywords = ClawOS;Hintergrundbild;Hintergrund;Slideshow;
...
xdg-entry-appearance-keywords = ClawOS;Akzent;Farbe;Symbol;Schriftart;Thema
...
xdg-entry-a11y-keywords = ClawOS;Barrierefreiheit;A11y;Bildschirm;Leser;Vergrößerungsglas;Kontrast;Farbe;
