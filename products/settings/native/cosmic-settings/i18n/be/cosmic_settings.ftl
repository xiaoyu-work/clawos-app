...
appearance = Выгляд
    .desc = Дамінуючыя колеры і тэмы ClawOS.
...
enable-export = Прымяніць гэтую тэму да праграм GNOME.
    .desc = Не ўсе інструменты падтрымліваюць аўтаматычнае пераключэнне. Для праграм, якія не належаць да ClawOS, можа спатрэбіцца перазапуск пасля змены тэмы.
