...
enable-export = Använd detta tema för GNOME program.
    .desc = Alla verktygssatser har inte stöd för automatisk växling. Icke ClawOS program kan behöva startas om efter en temaändring.
icon-theme = Ikontema
...
xdg-entry-appearance-keywords = ClawOS;Accent;Färg;Ikon;Teckensnitt;Tema
xdg-entry-dock-keywords = ClawOS;Docka;Panel;Applet;Miniprogram
xdg-entry-desktop-keywords = ClawOS;Skrivbord;
xdg-entry-about-keywords = ClawOS;Om
xdg-entry-a11y-keywords = ClawOS;Tillgänglighet;A11y; Skärm;Läsare;Förstoringsglas;Kontrast;Färg;
xdg-entry-date-time-keywords = ClawOS;Tidszon;Tid;Zon;
...
xdg-entry-input-keywords = ClawOS;Inmatning;Tangentbord;Mus;Möss;
xdg-entry-comment = Inställningsprogram för skrivbordsmiljön ClawOS
xdg-entry-default-apps-keywords = ClawOS;Standard;Program
xdg-entry-keywords = ClawOS;Inställningar;
xdg-entry-applications-keywords = ClawOS;Standard;Program;Uppstart;X11;Kompatibilitet
xdg-entry-displays-keywords = ClawOS;Skärm;
xdg-entry-mouse-keywords = ClawOS;Mus;Acceleration;Rullning;
xdg-entry-notifications-keywords = ClawOS;Avisering;Lås;
xdg-entry-startup-apps-keywords = ClawOS;Uppstart;Program;
xdg-entry-wired-keywords = ClawOS;Trådbundet;LAN;Nätverk;Anslutning;
xdg-entry-panel-keywords = ClawOS;Panel;Applet;Miniprogram
xdg-entry-time-language-comment = Hantera systemets datum, tid, region och språk
xdg-entry-x11-applications-keywords = ClawOS;X11;Program;Spel;Kompatibilitet;
xdg-entry-touchpad-keywords = ClawOS;Pekplatta;Gest;
xdg-entry-system-keywords = ClawOS;System;Info;Konton;Fast programvara;
xdg-entry-wireless-keywords = ClawOS;WiFi;Wi-Fi;Nätverk;Anslutning;
xdg-entry-network-keywords = ClawOS;Nätverk;Trådlöst;WiFi;VPN;
xdg-entry-wireless = Wi-Fi
xdg-entry-workspaces-keywords = ClawOS;Arbetsyta;Orientering;Översikt;Skärm;
xdg-entry-system-comment = Systeminformation, konton och uppdateringar av fast programvara
xdg-entry-wallpaper-keywords = ClawOS;Bakgrundsbild;Bakgrund;Bildspel;
xdg-entry-users-keywords = ClawOS;Användare;Konto;
xdg-entry-vpn-keywords = ClawOS;VPN;Nätverk;Anslutning;OpenVPN;OpenConnect;
xdg-entry-time-language-keywords = ClawOS;System;Tid;Datum;Region;Språk;
xdg-entry-sound-keywords = ClawOS;Ljud;Ljud;Varning;Pipewire;
xdg-entry-power-keywords = ClawOS;Ström;Batteri
xdg-entry-region-language-keywords = ClawOS;Region;Språk;Datum;Format;Tid;Lokal;Lokalisering;
xdg-entry-keyboard-keywords = ClawOS;Tangentbord;Inmatning;Källa;Genvägar;
xdg-entry-window-management-keywords = ClawOS;Fönster;Hantering;Kaklande;Super;Tangent;
