...
@pytest.mark.parametrize(("product", "app_ids"), [
    ...
    ("settings", ["accessibility-manager", "audio-manager", "bluetooth-manager", "camera-manager", "display-manager", "desktop-manager", "location-manager", "network-manager", "power-manager", "printer-manager"]),
])
