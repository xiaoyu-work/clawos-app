...
| `products/settings/` | Accessibility, audio, Bluetooth, camera, display and desktop App contracts; device/window execution, pairing sessions, capture persistence, display backup/restore and independent provider authority remain OS-owned |
