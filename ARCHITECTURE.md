...
| `products/settings/` | Accessibility, audio, Bluetooth and camera App contracts; Wayland/AT-SPI/PipeWire/BlueZ/GStreamer execution, pairing sessions, capture persistence and independent provider authority remain OS-owned |
