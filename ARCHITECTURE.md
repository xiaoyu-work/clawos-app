...
| `products/settings/` | Accessibility, audio and Bluetooth App contracts; Wayland/AT-SPI/PipeWire/BlueZ execution, pairing sessions and independent provider authority remain OS-owned |
