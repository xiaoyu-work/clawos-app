...
| `products/messaging-channels/` | Optional channel connector sources, starting with Discord; authenticated owner/sender admission, lifecycle and durable replay handling remain pending |
