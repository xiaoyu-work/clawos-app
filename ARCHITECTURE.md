...
| `products/messaging-channels/` | Discord/Telegram and outbound-only DingTalk/Google Chat/Lark/Matrix/Mattermost/Rocket.Chat/Signal/Slack/SMS/Teams/Webex/WhatsApp connector sources; authenticated inbound owner/sender admission, lifecycle and durable replay handling remain pending |
