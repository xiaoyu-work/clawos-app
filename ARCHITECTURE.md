...
| `products/settings/` | Accessibility and audio App contracts; session-bound Wayland/AT-SPI/PipeWire execution and independent provider authority remain OS-owned |
