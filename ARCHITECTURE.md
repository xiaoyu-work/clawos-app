...
| `products/messaging-channels/` | Discord and outbound-only DingTalk connector sources; authenticated inbound owner/sender admission, lifecycle and durable replay handling remain pending |
