...
| `products/settings/` | Accessibility, audio, Bluetooth, camera, display, desktop and location App contracts; device/window/GeoClue execution, stateful providers and independent authority remain OS-owned |
