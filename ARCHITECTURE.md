...
| `products/settings/` | Accessibility, audio, Bluetooth, camera and display App contracts; device/session execution, pairing sessions, capture persistence, display backup/restore and independent provider authority remain OS-owned |
