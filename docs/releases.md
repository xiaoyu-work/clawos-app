...
| OS media-player route | The `cosmic-player` consumer-name gate still needs a generic granted-capability/resource-owner replacement. Preserve its existing checks until that separate contract is implemented and verified. |
