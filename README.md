...
| Browser | [products/browser](products/browser/README.md) | `search` and headless `web` operations have moved; native UI and attached-browser entry point remain pending |
