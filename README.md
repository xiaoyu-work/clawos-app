...
| Settings | [products/settings](products/settings/README.md) | `accessibility-manager` has moved; native Settings and other management Apps remain pending; provider authority stays separate |
