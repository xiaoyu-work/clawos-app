...
| Settings | [products/settings](products/settings/README.md) | Accessibility, audio, Bluetooth, camera, display, desktop, location, network, power and printer manager Apps have moved; native Settings and other management Apps remain pending; provider authority stays separate |
