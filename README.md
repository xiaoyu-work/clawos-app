...
| Diagnostics | [products/diagnostics](products/diagnostics/README.md) | `hardware-center` and `crash-doctor` have moved with separate permissions; privileged collection stays OS-owned; `netdiag` is pending |
